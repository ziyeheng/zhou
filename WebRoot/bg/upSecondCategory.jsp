                    ...
                    <table class="insert-tab" width="100%">
                        ...
                        <c:forEach items="${secondclist}" var="cobj">
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="uscname" name="uscname" size="50" type="text" value="${cobj.name }">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red"></i>显示顺序：</th>
                                <td><input class="common-text" id="uscorder" name="uscorder" size="50" type="text" value="${cobj.order }"></td>
                            </tr>
                            <!--<tr>
                                   <th>内容：</th>
                            ...
                            <tr>
                                <th></th>
                                <td>
                                    <input class="btn btn-primary btn6 mr10" value="确定" type="button" id="uscbtn" name="uscbtn" onclick="upsecondcat();">
